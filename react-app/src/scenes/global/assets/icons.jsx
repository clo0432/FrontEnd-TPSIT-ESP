...
export const Logo = () => {
    return (
        <svg className="logo" width="67.5" height="42" viewBox="0 0 415 221" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
            <filter id="filter0_d_3_8" x="0.816231" y="0.186188" width="413.739" height="220.814" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
